    ...
    public partial class addSetup : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "3", "/images/RSC_Anderlecht.png", "RSC Anderlecht", "3", 500.0 },
                    { "4", "/images/Zulte_Waregem.png", "Zulte Waregem", "4", 250.0 },
                    { "2", "/images/Oostende.png", "Oostende", "2", 200.0 },
                    { "1", "/images/Club_Brugge.png", "Club Brugge", "1", 450.0 },
                    { "5", "/images/Genk.png", "Genk", "5", 350.0 },
                    { "6", "/images/AA_Gent.png", "AA Gent", "6", 300.0 }
                });
